...
**Inference Engine:** Processes data through the .pkl (Pickle) Random Forest model.   
...
**To auto clich the link for redirection from GitHub to another tab with the cloning link, [CLICK ME](https://github.com/mon148/HOTEL-INTELLIGENT-AND-REVENUE-PRESERVSTION-SYSTEM)**  
**Intialize the environment:** Note that i have included a batch which would automatically load and install all requirements to clone the repository provided your system doesn't flag it as a threat/error since some system do: python -m venv .venv  
